    ...
    <div className="h-full bg-white px-10">
          ...
          <div className="flex flex-col">
            <div className="h-full w-full">
              ...
              <img
                src="/progress.svg"
                alt=""
                className="-translate-x-32 -translate-y-20 w-50 h-30"
              />
            </div>
          </div>
        </div>
      ...
      <section>
        <div className="w-full h-full mt-15 mb-10">
          ...
          <div className="flex flex-col">
            ...
            {/* Card */}
            <div className="flex justify-around items-center mt-5 flex-nowrap gap-10 ">
              {/* Card 1 */}
              <FeatureCard
      ...
      <footer>
        <div className="flex justify-between w-full h-full mt-10 flex-1 mb-2">
          ...
          {/* middle */}
          <div className="flex justify-center items-start gap-20 flex-2">
            <div>
          ...
          <div className="flex flex-col gap-5 flex-1 justify-start items-end">
            <a href="https://www.github.com/abdocodes">
              <svg
                fill="#000000"
                width="24px"
                height="24px"
