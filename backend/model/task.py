...
class Task(db.Model):
  ...
  status: Mapped[TaskStatus] = mapped_column(sqlalchemyEnum(TaskStatus), default=TaskStatus.NOT_STARTED)
  ...
  def __repr__(self) -> str:
    ...
    return f"id=({self.id}), title={self.title} priority={self.priority}{duration_str}"
